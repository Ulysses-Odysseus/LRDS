    ...
    <div class="news nine columns">
      <div class="row">
        <div class="eight columns">
          <h1>SEARCH RESULTS <a class="rss" href="<?php bloginfo('rss_url'); ?>" target="_top" title="RSS Feed"><img src="<?= get_template_directory_uri(); ?>/images/rss_icon_large.png" border="0" alt="RSS Feed" /></a></h1>
        </div>
        ...
        <div class="eight columns">
          <?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>
              <article>
                  ...
                  <p><?php $content = get_the_content(); echo substr($content, 0, 150); ?>...</p>
                  <p><a href="<?php the_permalink() ?>" rel="bookmark" title="<?php the_title(); ?>">Read More</a></p>
              </article>
              <?php endwhile; else: ?>
            <p style="min-height:400px">Sorry, but no posts matched your search. Please try again!</p>
          <?php endif; ?>
        </div>
